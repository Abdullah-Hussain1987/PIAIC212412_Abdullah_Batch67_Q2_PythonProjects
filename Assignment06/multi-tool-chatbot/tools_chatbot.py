...
async def get_student_info(student_id: int) ->str:
    ...
    if student_info:
        ...
        return f"No information found for student ID: {student_id}"
...
async def starters():
    return [
        ...
        cl.Starter(
            label="Get Student Information",
            message="Fetch information about that student from student ID entered by user.",
...
async def start():
    ...
    agent = Agent(
        name="chatbot",
        instructions="""
        * You are a helpful, friendly and informative chatbot.
        * You can answer general questions and provide specific information.
        * For **weather inquiries**, you must fetch and share the current weather using **weather_tool**.
        * For **student-related queries**, you must retrieve details using the student ID and using **get_student_info** tool.
